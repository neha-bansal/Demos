...
public class TestResource {
	...
	public ChunkedOutput<String> getFromPojo() {
		...
		new Thread() {
			...
			public void run() {
				try {
					for (int i = 0; i < 3; i++) {
						output.write(new String("test: " + i + "<br/>"));
						Thread.sleep(2000);
					}
	...
	/**
	 * {@link org.glassfish.jersey.server.ChunkedOutput#close()} is called before method returns it's entity. Resource reproduces JERSEY-2558 issue.
	 * 
