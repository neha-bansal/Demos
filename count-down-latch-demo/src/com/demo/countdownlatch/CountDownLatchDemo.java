...
public class CountDownLatchDemo {
    ...
    public static void main(String args[]) {
       ...
       Thread cacheService = new Thread(new Service("CacheService", 2000, latch));
       ...
       try{
            latch.await(10000, TimeUnit.MILLISECONDS);  //main thread is waiting on CountDownLatch to finish
